        ...
        <div className="row">
          ...
          <div className={styles['features-items']}>
            <div className={styles['feature-item']}>
              ...
              <img src="./img/feature-security.png" alt="Ultimate security" className={styles['feature-img']} />
            </div>
            <div className={styles['feature-item']}>
              <span className={styles['feature-title']}>Hands like a cash</span>
              <img src="./img/feature-cash.png" alt="Hands like a cash" className={styles['feature-img']} />
            </div>
            <div className={styles['feature-item']}>
              <span className={styles['feature-title']}>Exchange</span>
              <img src="./img/feature-exchange.png" alt="Exchange" className={styles['feature-img']} />
            </div>
            <div className={styles['feature-item']}>
              <span className={styles['feature-title']}>Lorem Ipsum</span>
              <img src="./img/feature-dots.png" alt="Lorem Ipsum" className={styles['feature-img']} />
            </div>
          </div>
        </div>
      </div>
