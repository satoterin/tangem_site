...
const SectionFeature = () => {
  ...
  return (
    <>
    {searchModal && <SearchModal searchModal={searchModal} handleSearch={handleSearch} />}
      <div className='mt-16 mb-28 xl:mt-0 xl:mb-32'>
        <div className="flex flex-wrap md:flex-nowrap justify-between lg:justify-start mx-auto">
          ...
          <div className='w-full lg:w-auto mx-auto mt-7 md:mt-0 lg:mx-0 max-w-[696px]'>
            <picture>
              <source media='(max-width: 768px)' srcSet='./img/feature/feature-card-1x.png' />
