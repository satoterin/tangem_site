...
const SectionWaller = () => {
  ...
  return (
    <div className={classNames('md:container md:mx-auto md:px-12 xl:px-0 relative', styles['wallet'])}>
      <div className="md:absolute md:top-2/4 md:left-2/4 md:translate-y-[-50%]">
        <div className='pt-8 px-4 md:pt-4 lg:px-0 md:max-w-[370px] lg:max-w-[430px] xl:max-w-[520px]'>
          ...
          <p className='text-xl md:text-lg xl:text-2xl text-neutral-400 my-[30px] lg:mb-12 lg:text-left'>No wires or batteries. Just download the Tangem app to your phone and tap the card.</p>
          <div className='flex'>
