        ...
        >
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 md:gap-x-7 px-4 lg:px-0">
            <div className="flex flex-col items-center bg-[#090E13] rounded-20px p-8 mb-[1.875rem] md:mb-[50px] lg:mb-0 shadow-[0_30px_100px_-15px_rgba(0,0,0,0.15)]">
              <div className='max-h-60 h-[171px]'>
              ...
              <div className='mt-3 mb-[2.375rem] lg:mb-14 text-[1.063rem] lg:text-2xl text-center text-white opacity-50 lg:max-w-[437px]'>For the best security, there are 3 Tangem cards to one wallet. Ultimate backup!</div>
            ...
            <div className="flex flex-col items-center bg-white rounded-20px p-8 mb-24 md:mb-[50px] lg:mb-0 shadow-[0_30px_100px_-15px_rgba(0,0,0,0.15)]">
              ...
              <div className='mt-3 mb-[2.375rem] lg:mb-14 text-[1.063rem] lg:text-2xl text-center text-[#A6AAAD] lg:max-w-[377px]'>2 Tangem cards to one wallet. One for you, one for backup!</div>
